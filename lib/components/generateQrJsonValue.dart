...
class GenerateQrJsonValue extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return QrImageView(
      ...
      embeddedImage: type != ReefQrCodeType.accountJson
          ? const AssetImage('assets/images/reef.png')
          : null,
      embeddedImageStyle: type != ReefQrCodeType.accountJson
