  ...
  Widget build(BuildContext context) {
    return SliderTheme(
      data: SliderThemeData(
        ...
        valueIndicatorColor: widget.isDisabled == true ? Styles.textColor : Styles.secondaryAccentColorDark,
        thumbColor: widget.isDisabled == true ? Styles.textColor :Styles.secondaryAccentColorDark,
        inactiveTickMarkColor: Color(0xffc0b8dc),
        trackShape: GradientRectSliderTrackShape(
            gradient: widget.isDisabled == true ? Styles.buttonDisable : Styles.buttonGradient,
            darkenInactive: true),
