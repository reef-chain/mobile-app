          ...
          return BlurableContent(
            ...
            displayBalance,
                        ...
                        Observer(builder: (context) {
                          return BlurableContent(
                              Text(
                                "${balance != null && balance > BigInt.zero ? NumberFormat.compact().format((balance) / BigInt.from(10).pow(token.data.decimals)).toString() : 0} ${tokenName != "" ? tokenName : name.toUpperCase()}",
                                style: GoogleFonts.poppins(
                                  color: Styles.textColor,
                                  fontSize: 14,
