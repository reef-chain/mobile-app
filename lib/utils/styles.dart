...
class Styles {
  static Color primaryColor = Color(0xFF0E225D);
  ...
  static Color primaryAccentColorDark = Color(0xffba24c7);
  static const Color purpleColor = Color(0xffa93185);
  static const Color purpleColorLight = Color(0xffae27a5);
  static Color secondaryAccentColor = Color(0xff5531a9);
  static Color secondaryAccentColorDark = Color(0xff742cb2);
  static Color yellowColor = Color(0xFFDFE94B);
  static Color greenColor = Color(0xff26b686);
  ...
  static Color navColor = Color(0xffe5e1f0);
